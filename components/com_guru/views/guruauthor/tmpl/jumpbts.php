...
<form name="adminForm" action="<?php echo JUri::root(true) ?>/index.php?option=com_guru&controller=guruAuthor" method="post" class="uk-form uk-form-horizontal wk-form wk-form-horizontal" style="padding:25px;">
	<input type="button" class="uk-button uk-button-success uk-float-right wk-button wk-button-success wk-float-right" onclick="javascript:submitbutton()" value="<?php echo JText::_("GURU_SAVE"); ?>" />
