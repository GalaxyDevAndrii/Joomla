...
$document->addScriptOptions('guru.tabViewComponent', $uri->toString());
...
function createButton($buy_background, $course_id, $buy_class, $program, $program_content){
    ...
    if((isset($expired_date_string) && $expired_date_string != "0000-00-00 00:00:00") || (!isset($result) || intval($result) == 0)){
        ...
        $jnow = new JDate('now');
        $current_date_string = $jnow->toSQL(true);
        ...
        $return = '<a href="'.$return.'"><i class="uk-icon-bullhorn wk-icon-bullhorn"></i> '.JText::_("GURU_ACCESS_BUT_BUTTON").'</a>';
    }
    ...
    if($chb_free_courses == 1){// free for
        if($step_access_courses){// members
            ...
            if($mandatory_login){
                $return = '<div class="uk-grid wk-grid">
                                ...
                                <div class="uk-width-large-2-10 uk-width-medium-1-1 uk-width-small-1-1 wk-width-large-2-10 wk-width-medium-1-1 wk-width-small-1-1">
                                    <input type="button" class="uk-button uk-button-success uk-button-small wk-button wk-button-success wk-button-small" onclick="document.location.href=\''.JRoute::_("index.php?option=com_guru&view=guruprograms&task=enroll&action=enroll&cid=".$course_id).'\';" value="'.JText::_("GURU_ENROLL_NOW").'" name="Enroll" />
                                </div>
                            </div>';
            }
            else{
            ...
            if($step_access_courses == 0 && !$expired){// Students
                if($selected_course == '-1'){// any course
                    if($user_id == 0){//not logged
                        ...
                        $return = ' <div class="uk-grid wk-grid">
                                        <div class="uk-width-large-1-1 uk-width-medium-1-1 uk-width-small-1-1 wk-width-large-1-1 wk-width-medium-1-1 wk-width-small-1-1">
                                            <p>'.JText::_("GURU_FREE_ALL_STUDENTS_LOG_HERE").' <a class="inactive-lesson" href="javascript:;" onclick="openMyModal(\'0\', \'0\', \''.JURI::root().'index.php?option=com_guru&view=guruLogin&tmpl=component&Itemid='.intval($itemid).'&returnpage=open_lesson&lesson_id='.$course_id.'\'); return false;">'.JText::_("GURU_LOGIN_HERE").'</a></p>
                                        </div>
                                    </div>';
                    }
                    else{
                        if(hasAtLeastOneCourse()){
                            $red_bar = true;
                            $return = ' <div class="uk-grid wk-grid">
                                            <div class="uk-width-large-8-10 uk-width-medium-1-1 uk-width-small-1-1 wk-width-large-8-10 wk-width-medium-1-1 wk-width-small-1-1">
                        ...
                        $return = ' <div class="uk-grid wk-grid">
                                    ...
                                    <div class="uk-grid wk-grid margin-2">
                                        ...
                                        <div class="uk-width-large-2-10 uk-width-medium-1-1 uk-width-small-1-1 wk-width-large-2-10 wk-width-medium-1-1 wk-width-small-1-1 padding-none">
                                            <input type="button" class="uk-button uk-button-success uk-button-small wk-button wk-button-success wk-button-small" onclick="document.location.href=\''.JURI::root()."index.php?option=com_guru&view=guruPrograms&task=buy_action&course_id=".$course_id."&Itemid=".intval($itemid).'\';" value="'.JText::_("GURU_BUY_NOW").'" name="Buy" />
                                        </div>
                                    </div>';
                    }
                    else{
    ...
    $bar_class = "uk-alert wk-alert";

    if($red_bar){
        $bar_class = "uk-alert uk-alert-danger wk-alert wk-alert-danger";
    }
    
    $access_bar = '<div class="'.$bar_class.' uk-hidden-small wk-hidden-small hidden-phone course-access-bar">';
...
<div><!-- start main div-->
    <div class="table-of-contents">            
        <div class="uk-grid wk-grid">
            ...
            $show_all_cloase_all_default = isset($course_config->show_all_cloase_all_default) ? $course_config->show_all_cloase_all_default : "0";
            ...
            <?php
                if($show_all_cloase_all != 1){
                    ?>
                        <input type="button" class="uk-button uk-button-primary wk-button wk-button-primary show_sub" value="+ <?php echo JText::_("GURU_SHOW_ALL_BUTTON"); ?>"/><!--show all button -->
                        <input type="button" class="uk-button uk-button-primary wk-button wk-button-primary close_sub" value="- <?php echo JText::_("GURU_CLOSE_ALL_BUTTON"); ?>"/><!--close all button -->
                    <?php
                }
                else{
                    echo '';
            ...
            <div class="uk-width-1-2 uk-hidden-small wk-width-1-2 wk-hidden-small hidden-phone">
                ...
                ?>
                        <div class="col_title pull-left uk-width-1-<?php echo intval($nr_columns); ?> wk-width-1-<?php echo intval($nr_columns); ?> ">
                            <?php
        ...
        if($user_id > 0){
            $db = JFactory::getDBO();
            $sql = "SELECT order_date FROM `#__guru_order`
                WHERE userid = $user_id
                AND (courses LIKE '{$course_id}-%' OR courses LIKE '%|{$course_id}-%')
                AND `status` = 'Paid'
            ...
            <div class="guru-tabs chapter_wrap t_row">
                        ...
                        <div class="guru-tab-title chapter_title clearfix">
                            <div class="day clearfix" onClick="javascript:show_hidde('<?php echo $module['id'];?>','<?php echo JUri::root()."components/com_guru/images/";?>')">
                                <?php
                                    if(intval($show_all_cloase_all_default) == 0){
                                ?>
                                ...
                                ?>
                                        <img id='img_<?php echo $device."_".$module['id']; ?>' src='<?php echo JUri::root()."components/com_guru/images/arrow-down.gif";?>' />
                                <?php  
                                    }
                                ?>
                                <?php
                        ...
                        ?>
                                <div class="lessons_wrap">                          
                                    <div id='td_<?php echo $device."_".$module['id']; ?>' style="<?php if(intval($show_all_cloase_all_default) == 1){echo 'display:none;';} ?>" >
        ...
        // end changes for lessons per release
                                                        ...
                                                        if(isset($lesson['duration']) && trim($lesson['duration']) != ""){
                                                            ...
                                                            @$total_minutes += settype($temp_duration[0], "integer");
                                                            @$total_seconds += settype($temp_duration[1], "integer");
                                                        ...
                                                        if($lesson["can_open_lesson"] == "1"){ // access to this lesson
                                                            if($config->open_target == 0 && FALSE){ // same window
                                                                $link = JUri::root() . "index.php?option=com_guru&view=gurutasks&catid=".$program->catid."&module=".$module["id"]."-".$module["alias"]."&cid=".$lesson['id']."-".$lesson["alias"]."&Itemid=".intval($itemid);
                                                ...
                                                ?>
                                                        <li class="uk-grid wk-grid" <?php echo $style; ?>>
                                                            <div class="uk-width-1-2 wk-width-1-2 lesson_name">
                                                                ...
                                                                ?>
                                                                        <a id="<?php echo $lesson_html_id; ?>" href="javascript:;" <?php echo $style; ?> class="<?php echo $inactive_lesson_class; ?>">
                                                            ...
                                                            <div class="uk-width-1-2 wk-width-1-2" style="padding-left: 0px;">
                                                                ...
                                                                if(isset($course_config->quiz_status) && $course_config->quiz_status == 0){
                                                            ?>
                                                                    <div class="uk-width-1-<?php echo $nr_columns - 1; ?> wk-width-1-<?php echo $nr_columns - 1; ?> pull-left ">
                                                                        <?php
                                                                            if(isset($lesson["quiz_passed"]) && $lesson["quiz_passed"] == -1 && !$expired_license){
                                                                                // pending
                                                                                echo '<div class="lesson-quiz-status lesson-quizz-pending"><span class="hidden-phone">'.JText::_("GURU_PENDING").'</span> <i class="uk-icon-spinner wk-icon-spinner" title="'.JText::_("GURU_PENDING").'" data-uk-tooltip></i></div>';
                                                                            }
                                                                            elseif(isset($lesson["quiz_passed"]) && $lesson["quiz_passed"] == 0 && !$expired_license){
                                                                                // failed
                                                                                echo '<div class="lesson-quiz-status lesson-quizz-failed"><span class="hidden-phone">'.JText::_("GURU_QUIZ_FAILED_STATUS").'</span> <i class="uk-icon-close wk-icon-close" title="'.JText::_("GURU_QUIZ_FAILED_STATUS").'" data-uk-tooltip></i></div>';
                                                                            }
                                                                            elseif(isset($lesson["quiz_passed"]) && $lesson["quiz_passed"] == 1 && !$expired_license){
                                                                                // passed
                                                                                echo '<div class="lesson-quiz-status lesson-quizz-passed"><span class="hidden-phone">'.JText::_("GURU_QUIZ_PASSED_STATUS").'</span> <i class="uk-icon-check-square-o wk-icon-check-square-o" title="'.JText::_("GURU_QUIZ_PASSED_STATUS").'" data-uk-tooltip></i></div>';
                                                                            }
                                                                            elseif(isset($lesson["quiz_passed"]) && $lesson["quiz_passed"] == 2 && !$expired_license){
                                                                                // pending assessment
                                                                                echo '<div class="lesson-quiz-status lesson-quizz-pending"><span class="hidden-phone">'.JText::_("GURU_PENDING_ASSESSMENT").'</span> <i class="uk-icon-spinner wk-icon-spinner" title="'.JText::_("GURU_PENDING_ASSESSMENT").'" data-uk-tooltip></i></div>';
                                                                            }
                                                                            elseif(!isset($lesson["quiz_passed"]) && !$expired_license){
                                                                                if(trim($lesson["duration"]) != ""){
                                                                                    if(isset($lesson["show_view_status"]) && intval($lesson["show_view_status"]) == 1){
                                                                                        $lesson_duration = $lesson["duration"];
                                                                                        $lesson_duration_array = explode("x", $lesson_duration);
                                                                                        $lesson_duration_min = $lesson_duration_array["0"];
                                                                                        $lesson_duration_sec = $lesson_duration_array["1"];

                                                                                        if(!isset($lesson_duration_min) || trim($lesson_duration_min) == ""){
                                                                                            $lesson_duration_min = "00";
                                                                                        }

                                                                                        if(!isset($lesson_duration_sec) || trim($lesson_duration_sec) == ""){
                                                                                            $lesson_duration_sec = "00";
                                                                                        }

                                                                                        if(!isset($lesson["viewed_time"]) || (isset($lesson["viewed_time"]) && trim($lesson["viewed_time"]) == "")){
                                                                                            echo '<div class="lesson-quiz-status lesson-quizz-pending"><span class="hidden-phone">'.JText::_("GURU_PENDING_LESSON").'</span></div>';
                                                                                        }
                                                                                        elseif(isset($lesson["viewed_time"]) && trim($lesson["viewed_time"]) != ""){
                                                                                            $lesson_viewed_time = $lesson["viewed_time"];
                                                                                            $lesson_viewed_time_array = explode(":", $lesson_viewed_time);
                                                                                            $lesson_viewed_time_min = $lesson_viewed_time_array["1"];
                                                                                            $lesson_viewed_time_sec = $lesson_viewed_time_array["2"];

                                                                                            $date_duration = strtotime(date("Y-m-d 00:".$lesson_duration_min.":".$lesson_duration_sec));
                                                                                            $date_viewed = strtotime(date("Y-m-d 00:".$lesson_viewed_time_min.":".$lesson_viewed_time_sec));

                                                                                            if($date_duration <= $date_viewed){
                                                                                                echo '<div class="lesson-quiz-status lesson-quizz-passed"><span class="hidden-phone">'.JText::_("GURU_VIEWED_LESSON").'</span></div>';
                                                                                            }
                                                                                            else{
                                                                                                echo '<div class="lesson-quiz-status lesson-quizz-failed"><span class="hidden-phone">'.JText::_("GURU_NOT_VIEWED_LESSON").'</span></div>';
                                                                                            }
                                                                                        }
                                                                                        else{
                                                                                            echo '&nbsp;';
                                                                                    ...
                                                                                    if(isset($lesson["show_view_status"]) && intval($lesson["show_view_status"]) == 1){
                                                                                            echo '<div class="lesson-quiz-status lesson-quizz-passed"><span class="hidden-phone">'.JText::_("GURU_UNLIMITED").'</span></div>';
                                                                                    }
                                                                                    else{
                                                                                        echo '&nbsp;';
                                                                                    }
                                                            ...
                                                            ?>
                                                                ...
                                                                <div style="visibility:<?php echo $display; ?>;" class="uk-width-1-<?php echo $nr_columns - 1; ?> wk-width-1-<?php echo $nr_columns - 1; ?> viewed viewed-<?php echo $lesson["id"]; ?> pull-left ">
                                                                    <i class="fa fa-eye"></i>
                                                                </div>
                                                            ...
                                                            <?php
                                                                ...
                                                                <?php
                                                                    ...
                                                                    $available_date = str_replace("replace_class", 'uk-width-1-'.($nr_columns - 1).' wk-width-1-'.($nr_columns - 1), $available_date);
...
function tab2($program, $device){
    $description = $program->description;

    if($device == "mobile"){
        $description = str_replace(array('#my-id', '"my-id"'), array('#my-id-mob', '"my-id-mob"'), $description);
    }
?>
    <div class="">
...
<?php
    ...
    <script type="text/javascript">
            ...
            ?>
                    document.write('<a target="_blank" href="<?php echo JURI::root()."index.php?option=com_guru&controller=guruTasks&task=download&media=".intval($element->id)."&course=".intval($course_id)."&tmpl=component&format=raw"; ?>"><img src="<?php echo JUri::root() ?>components/com_guru/images/doc.gif" alt="<?php echo $element->type; ?>" align="absmiddle" />&nbsp;<?php echo $element->local; ?></a>');
            <?php
                }
                elseif($element->type == "docs" && trim($element->url) != ""){
            ?>
                    document.write('<a target="_blank" href="<?php echo JUri::root(true) . $element->url; ?>"><img src="<?php echo JUri::root() ?>components/com_guru/images/doc.gif" alt="<?php echo $element->type; ?>" align="absmiddle" />&nbsp;<?php echo $element->name; ?></a>');
            <?php
                }
                elseif($element->type == "file" && trim($element->local) != ""){
            ?>
                    document.write('<a target="_blank" href="<?php echo JURI::root()."index.php?option=com_guru&controller=guruTasks&task=download&media=".intval($element->id)."&course=".intval($course_id)."&tmpl=component&format=raw"; ?>"><img src="<?php echo JUri::root() ?>components/com_guru/images/file.gif" alt="<?php echo $element->type; ?>" align="absmiddle" />&nbsp;<?php echo $element->local; ?></a>');
            <?php
                }
            }
            else{
                            ...
                            <div class='uk-width-2-10 wk-width-2-10'>
                                ...
                                ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_guru&view=guruauthor&layout=view&task=author&cid='.$author->id."-".JFilterOutput::stringURLSafe($author->name)."&Itemid=".intval($itemid)); ?>">
                                        ...
                                        <img class="thumbnail pull-left" src='<?php echo $site_home.$author->images; ?>' alt='author image' align='<?php echo $align;?>' /></a>
                                    <?php   } ?>
                            </div>
                                    ...
                                    <div class="table_container columns">
                                        <table class="uk-table uk-table-striped wk-table wk-table-striped">
                                            <tr>
                                                ...
                                                <th class="uk-text-center wk-text-center"><?php echo JText::_("GURU_TAB_AUTHOR_COURSES_LEVEL"); ?></th>
                                                <th class="uk-text-center wk-text-center"><?php echo JText::_("GURU_TAB_AUTHOR_COURSES_RELEASE");?></th>
                                            </tr>
                                            <?php
                                            $k = 0;
                                            ...
                                            ?>
                                                <tr class="<?php echo $class; ?>">          
                                                    ...
                                                    <td class="uk-text-center wk-text-center"><img src='<?php echo JURI::root()."components/com_guru/images/".$course[$i]->level.".png"; ?>'/></td>
                                                    <?php
                                                        $int_date    = strtotime($course[$i]->startpublish);
                                                        $date        = date($config->datetype, $int_date);
                                                    ?>
                                                    <td class="uk-text-center wk-text-center"><?php echo $date; ?></td>
                                                </tr>
                                            <?php
                                            $k++;
                                                }
...
function createTabs($program, $author, $program_content, $exercise, $requirements, $course, $config, $course_config){
    ...
    JHtml::stylesheet("components/com_guru/css/tabs_css.css");
            ...
            <div class="uk-clearfix wk-clearfix">
                <div id="accordion" class="accordion uk-margin-top wk-margin-top">
                    ...
                    <?php
                                        ...
                                        if(intval($default_active_tab) == 2){ // active desc but this is not visible
                ...
                <ul class="uk-tab uk-tab-grid uk-padding-remove wk-tab wk-tab-grid wk-padding-remove" data-uk-tab>
                        ...
                        if(isset($tabs_order) && count($tabs_order) > 0){
                            foreach($tabs_order as $tab_name=>$order){
                                ...
                                if($tab_name == "tab1"){
                                    ...
                                    if(!empty($program_content) && $course_config->course_table_contents == "0"){
                    ?>
                                        <li id="li-tab1" class="uk-width-1-6 wk-width-1-6 <?php if(intval($default_active_tab) == 1){echo 'uk-active';} ?> "><a href="javascript:;" onclick="javascript:changeGuruTab('tab1'); return false;"><i class="uk-icon-bars wk-icon-bars"></i> <?php echo JText::_("GURU_TAB_TABLE_CONTENTS");?></a></li>
                    <?php
                                    }
                                }
                                ...
                                if($tab_name == "tab2"){
                                    if($program->description != "" && $course_config->course_description_show == "0"){
                    ?>
                                        <li id="li-tab2" class="uk-width-1-6 wk-width-1-6 <?php if(intval($default_active_tab) == 2){echo 'uk-active';} ?> "><a href="javascript:;" onclick="javascript:changeGuruTab('tab2'); return false;"><i class="uk-icon-file-text-o wk-icon-file-text-o"></i> <?php echo JText::_("GURU_TAB_DESCRIPTION");?></a></li>
                    <?php
                                    }
                                }
                                ...
                                if($tab_name == "tab3"){
                                    if($course_config->course_tab_price == "0" && !is_array(@$button)){
                    ?>
                                        <li id="li-tab3" class="uk-width-1-6 wk-width-1-6 <?php if(intval($default_active_tab) == 3){echo 'uk-active';} ?> "><a href="javascript:;" onclick="javascript:changeGuruTab('tab3'); return false;"><i class="uk-icon-usd wk-icon-usd"></i> <?php echo JText::_("GURU_BUY_PRICE");?></a></li>
                    <?php
                                    }
                                }
                                ...
                                if($tab_name == "tab6"){
                                    if(!empty($exercise) && $config->course_exercises == "0"){
                    ?>
                                        <li id="li-tab4" class="uk-width-1-6 wk-width-1-6 <?php if(intval($default_active_tab) == 6){echo 'uk-active';} ?> "><a href="javascript:;" onclick="javascript:changeGuruTab('tab4'); return false;"><i class="uk-icon-folder-o wk-icon-folder-o"></i> <?php echo JText::_("GURU_EXERCISE_FILES");?></a></li>
                    <?php
                                    }
                                }
                                ...
                                if($tab_name == "tab4"){
                                    if($course_config->course_author == "0"){
                    ?>
                                        <li id="li-tab5" class="uk-width-1-6 wk-width-1-6 <?php if(intval($default_active_tab) == 4){echo 'uk-active';} ?> ">
                    ...
                    <?php
                                ...
                                if($tab_name == "tab5"){
                                    if((!empty($requirements) || $program->pre_req!="" || $program->pre_req_books!="" || $program->reqmts!="") && ($course_config->course_requirements == "0") && !is_array(@$button)){
                    ?>
                                        <li id="li-tab6" class="uk-width-1-6 wk-width-1-6 <?php if(intval($default_active_tab) == 5){echo 'uk-active';} ?> "><a href="javascript:;" onclick="javascript:changeGuruTab('tab6'); return false;"><i class="uk-icon-info wk-icon-info"></i> <?php echo JText::_("GURU_TAB_REQUIREMENTS");?></a></li>
                    <?php
                                    }
                                }
                            }
