...
//        'fill-in':{'pre':'^(((\{case_matters=(true|false)\})(\{order_matters=(true|false)\})?)|((\{order_matters=(true|false)\})(\{case_matters=(true|false)\})?))(.*?)$',
    ...
    var datamodel =  {
        ...
        'cmi.completion_threshold':{'defaultvalue':<?php echo !empty($userscormdata->threshold)?'\''.$userscormdata->threshold.'\'':'null' ?>, 'mod':'r'},
        ...
        'cmi.launch_data':{'defaultvalue':<?php echo !empty($userscormdata->datafromlms)?'\''.$userscormdata->datafromlms.'\'':'null' ?>, 'mod':'r'},
        ...
        'cmi.location':{'defaultvalue':<?php echo !empty($userscormdata->{'cmi.location'})?'\''.$userscormdata->{'cmi.location'}.'\'':'null' ?>, 'format':CMIString1000, 'mod':'rw'},
        'cmi.max_time_allowed':{'defaultvalue':<?php echo !empty($userscormdata->attemptAbsoluteDurationLimit)?'\''.$userscormdata->attemptAbsoluteDurationLimit.'\'':'null' ?>, 'mod':'r'},
        ...
        'cmi.progress_measure':{'defaultvalue':<?php echo !empty($userscormdata->{'cmi.progress_measure'})?'\''.$userscormdata->{'cmi.progress_measure'}.'\'':'null' ?>, 'format':CMIDecimal, 'range':progress_range, 'mod':'rw'},
        'cmi.scaled_passing_score':{'defaultvalue':<?php echo !empty($userscormdata->{'cmi.scaled_passing_score'})?'\''.$userscormdata->{'cmi.scaled_passing_score'}.'\'':'null' ?>, 'format':CMIDecimal, 'range':scaled_range, 'mod':'r'},
        'cmi.score._children':{'defaultvalue':score_children, 'mod':'r'},
        'cmi.score.scaled':{'defaultvalue':<?php echo !empty($userscormdata->{'cmi.score.scaled'})?'\''.$userscormdata->{'cmi.score.scaled'}.'\'':'null' ?>, 'format':CMIDecimal, 'range':scaled_range, 'mod':'rw'},
        'cmi.score.raw':{'defaultvalue':<?php echo !empty($userscormdata->{'cmi.score.raw'})?'\''.$userscormdata->{'cmi.score.raw'}.'\'':'null' ?>, 'format':CMIDecimal, 'mod':'rw'},
        'cmi.score.min':{'defaultvalue':<?php echo !empty($userscormdata->{'cmi.score.min'})?'\''.$userscormdata->{'cmi.score.min'}.'\'':'null' ?>, 'format':CMIDecimal, 'mod':'rw'},
        'cmi.score.max':{'defaultvalue':<?php echo !empty($userscormdata->{'cmi.score.max'})?'\''.$userscormdata->{'cmi.score.max'}.'\'':'null' ?>, 'format':CMIDecimal, 'mod':'rw'},
        ...
        'cmi.suspend_data':{'defaultvalue':<?php echo !empty($userscormdata->{'cmi.suspend_data'})?'\''.$userscormdata->{'cmi.suspend_data'}.'\'':'null' ?>, 'format':CMIString64000, 'mod':'rw'},
        'cmi.time_limit_action':{'defaultvalue':<?php echo !empty($userscormdata->timelimitaction)?'\''.$userscormdata->timelimitaction.'\'':'null' ?>, 'mod':'r'},
