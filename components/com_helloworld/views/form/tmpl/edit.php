...
<form action="<?php echo JRoute::_('index.php?option=com_helloworld&view=form&layout=edit'); ?>"
	...
	<div class="btn-toolbar">
		<div class="btn-group">
			<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('helloworld.compare')">
				<span class="icon-ok"></span><?php echo JText::_('COM_HELLOWORLD_HELLOWORLD_COMPARE') ?>
			</button>
		</div>
	</div>
