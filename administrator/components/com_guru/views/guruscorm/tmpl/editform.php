...
<script language="javascript" type="text/javascript">	
	...
	function changeTeacher(teacher_id){
		ajax_url = "index.php?option=com_guru&controller=guruScorm&task=getTeacherCoursesSelect&tmpl=component";
		var data = {
...
<form method="post" name="adminForm" id="adminForm">
	<fieldset class="adminform">
		<table class="admintable">
			<tr>
				...
				<td>
					<input type="text" id="title" name="title" value="<?php echo $scorm["title"]; ?>" />
				</td>
			</tr>
			...
			<tr style="display: none;">
				...
				<td>
					<?php
						...
						echo $editor->display('description', $scorm["description"], '100%', '200px', '10', '50');
					?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
                    ...
                    <?php
                    	if(isset($scorm["file"]) && trim($scorm["file"]) != ""){
                    ?>
                    		<div style="clear: both;"><?php echo $scorm["file"]; ?></div>
                    <?php
                    	}
                    ?>
                    <input type="hidden" name="file" id="file" value="<?php echo $scorm["file"]; ?>" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="checkbox" name="published" value="1" <?php if($scorm["published"] == '1'){ echo 'checked';} ?> /><span class="lbl"></span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo JHTML::calendar($scorm["start"], 'start', 'start', $format, array("showTime"=>"", "todayBtn"=>"", "weekNumbers"=>"", "fillTable"=>"", "singleHeader"=>"")); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo JHTML::calendar($scorm["end"], 'end', 'end', $format, array("showTime"=>"", "todayBtn"=>"", "weekNumbers"=>"", "fillTable"=>"", "singleHeader"=>"")); ?>
				</td>
			</tr>
	...
	<input type="hidden" name="id" value="<?php echo $scorm["id"]; ?>" />
