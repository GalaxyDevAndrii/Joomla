...
JSDragDropTree.prototype = {
	...
	*/
	...
	updateLessonOrdering: function() {
		...
		var url = Joomla.getOptions('system.paths').base + '/index.php?option=com_guru&controller=guruPrograms&tmpl=component&format=raw&task=saveOrderS';
